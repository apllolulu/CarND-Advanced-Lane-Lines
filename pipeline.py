...
import line
import sys
sys.path.append('/media/ora/362b0807-5852-4af1-8f79-03a42964afb0/xy/lane-detection/CarND-Advanced-Lane-Lines')
#/home/ora/anaconda3/envs/tensorflow/lib/python3.6/site-packages
sys.path.append('/home/ora/anaconda3/envs/tensorflow/lib/python3.6/site-packages')
#print(sys.path)
...
#project_outpath = 'vedio_out/project_video_out_12.5.mp4'
#project_video_clip = VideoFileClip("project_video.mp4")

#project_outpath = 'vedio_out/challenge_video_out_12.5.mp4'
#project_video_clip = VideoFileClip("challenge_video.mp4")

project_outpath = 'vedio_out/harder_challenge_video_out_12.5.mp4'
